...
String toString(){
 ...
 //Abfrage auf doppelten stapel
 Userdata userdata = new Userdata();
 while(userdata.sucheInListe(userdata.stapel, s.getThemengebietName()) != null ){
  s.mit_themengebiet(s.getThemengebietName() + "´");
  for(int i = 8; i < l.length; i = i +5) {
   l[i] = l[i]+"´";
  }
 }
